...
--
-- Host: localhost    Database: perdidosachados
-- ------------------------------------------------------
...
INSERT INTO `category` VALUES (2,'Roupas',NULL),(3,'Utensílios',NULL);
...
CREATE TABLE `claim` (
  ...
  `claim_accepted` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`claim_id`),
  KEY `FK_claim_user` (`id_user`),
  KEY `FK_claim_item` (`id_item`),
...
CREATE TABLE `item` (
  ...
  `id_user` int DEFAULT NULL,
  PRIMARY KEY (`item_id`),
  KEY `FK_item_user` (`id_user`),
  KEY `FK_item_local` (`id_local`),
  KEY `FK_item_status` (`id_status`),
...
CREATE TABLE `phone` (
  ...
  UNIQUE KEY `phone_nr` (`phone_nr`),
  KEY `FK_phone_user` (`id_user`),
...
INSERT INTO `role` VALUES (1,'GUEST','Just to see lost or found items'),(2,'USER','GUEST privileges + can publish items and also claim'),(4,'ADMIN','all privileges');
...
INSERT INTO `status` VALUES (1,'Perdido',NULL),(2,'Achado',NULL);
...
-- Dump completed on 2024-10-23  7:25:36
